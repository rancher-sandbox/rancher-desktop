<script>
import LabeledFormElement from '@/src/mixins/labeled-form-element';
import TextAreaAutoGrow from '@/src/components/form/TextAreaAutoGrow.vue';
import LabeledTooltip from '@/src/components/form/LabeledTooltip.vue';
