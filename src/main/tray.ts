...
export class Tray extends EventEmitter {
  #trayMenu: Electron.Tray;
  #contextClick?: (menuItem: Electron.MenuItem) => void;
  #contextMenuItems: Electron.MenuItemConstructorOptions[] = [
    {
      id:      'state',
      enabled: false,
  ...
  buildFromConfig(configPath: string) {
   ...
   */
  settingsChanged(settings: import('../config/settings').Settings) {
    this.updateMenu();
  }
   ...
   */
  contextClick(menuItem: Electron.MenuItem) {
